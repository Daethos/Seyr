...
async function handleSubmit(e: any) {
  ...
  return (
    <Container fluid>
        ...
        <Messages user={user} userMessages={userMessages} friendMessages={friendMessages} friendID={friendID} friend={friendProfile} handleChange={handleChange} handleSubmit={handleSubmit} />
      ...
      <FormMessage user={user} friendProfile={friendProfile} messageDraft={messageDraft} friendID={friendID} handleChange={handleChange} handleSubmit={handleSubmit} />
