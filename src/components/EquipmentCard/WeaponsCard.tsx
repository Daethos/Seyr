...
const WeaponsCard = ({ weapon, index, show, setModalShow }: WeaponProps) => {
    const weaponPopover = (
        <Popover className="text-info" id="popover">
            ...
            <Popover.Body id="weapon-popover-body" className="text-info">
  ...
  return (
            ...
            <OverlayTrigger trigger="click" placement="bottom" overlay={weaponPopover}>
                <Button variant="outline-info" size="lg" className="m-3 p-4">{weapon.name}</Button>
            </OverlayTrigger>
