...
const FeelingsCard = ({ loggedUser, ascean }: Props) => {
  ...
  return (
    <div className="actions">
      ...
      {
        asceanFeelings.likes.length > 0
        ? 
        <p style={{ marginLeft: -10 + '%' }}>
          {asceanFeelings.likes.length}
        </p>
        : ''
      }
      ...
      {
        asceanFeelings.dislikes.length > 0
        ? 
        <p style={{ marginLeft: -10 + '%' }}>
          {asceanFeelings.dislikes.length}
        </p>
        : ''
      }
      
      <svg 
          onClick={doubleDislikeHandler} 
      ...
      {
        asceanFeelings.double_dislikes.length > 0
        ? 
        <p style={{ marginLeft: -10 + '%' }}>
          {asceanFeelings.double_dislikes.length}
        </p>
      : ''
      }
