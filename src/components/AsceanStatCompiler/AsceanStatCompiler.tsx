...
const AsceanStatCompiler = ({ ascean, communityFocus }: Props) => {
    ...
    <h4>Critical:</h4>  <p>+{Math.round(weaponOne?.critical_chance)}% / x{weaponOne?.critical_damage} Damage </p><br />
   ...
   { 
    ...
    <h4>Critical:</h4>  <p>+{Math.round(weaponTwo?.critical_chance)}% / x{weaponTwo?.critical_damage} Damage </p><br />
    ...
    <h4>Critical:</h4>  <p>+{Math.round(weaponThree?.critical_chance)}% / x{weaponThree?.critical_damage} Damage </p><br />
