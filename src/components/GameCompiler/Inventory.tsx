...
interface Props {
    ...
    highlighted?: { item: any; comparing: boolean; };
};
...
const Inventory = ({ ascean, inventory, bag, gameDispatch, blacksmith, index, gameState, story, compare, setHighlighted, highlighted }: Props) => {
    ...
    const [weaponCompared, setWeaponCompared] = useState<any>(null);
    const [ringCompared, setRingCompared] = useState<any>(null)
