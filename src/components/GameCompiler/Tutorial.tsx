          ...
          overflow: 'scroll',
            ...
            { firstInventory ? (
                <h6 className='overlay-content' style={{ animation: "fade 1s ease-in 0.5s forwards", marginTop: "25%" }}>
                    ...
                    Equip - This will equip the item to the slot you have selected, and unequip the item currently in that slot, placing it in your inventory.
                    <br /><br />
                    <p style={{ color: '#fdf6d8' }}>
            ...
            { firstLoot ? (
                <h6 className='overlay-content' style={{ animation: "fade 1s ease-in 0.5s forwards", marginTop: "25%"}}>
                    ...
                    If you wish to keep the item, inpsect the gear itself and click 'save' in order to add it into your inventory. If you do not and exit the conversation, it will be lost forever.
