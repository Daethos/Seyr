...
const styleMap: StyleMap = {
  ...
  godBorderConstitution: {
    ...
    borderRadius: "50%",
    maxWidth: "50vw",
    border: "3px solid #fdf6d8",
    boxShadow: "0 0 5em #fdf6d8",
  },
  godBorderStrength: {
    marginBottom: "15%",
    marginTop: "15%",
