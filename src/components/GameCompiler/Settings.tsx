...
const Settings = ({ ascean, dispatch, gameDispatch, inventory, currentTile, saveAsceanCoords, gameState, mapState }: Props) => {
    ...
    return (
        ...
        <p style={{ color: '#fdf6d8' }}>
            ...
            Invoke - Your Mastery and Adherence or Devotion dictate what you can perform in an instant. As you grow, so too does your ability to sway chance.
        </p>
            <br />
            <br />
        <p style={{ color: 'gold' }}>
        ...
        <h3 style={{ fontSize: 12 + 'px', textAlign: 'center', color: 'goldenrod' }}>
