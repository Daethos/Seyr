...
const DialogBox = ({ state, dispatch, ascean, enemy, npc, dialog, getOpponent, playerWin, computerWin, resetAscean, winStreak, loseStreak, highScore, lootDrop, setLootDrop, lootDropTwo, setLootDropTwo, itemSaved, setItemSaved }: Props) => {
    ...
    const regionInformation = {
        ...
        Kingdom: "The King, Mathyus Caderyn II, has been away from his court as of late, his son Dorien sitting the throne--though constant feathers aid his communication when abroad. Despite its unification, groands have increased with disparate and slow recovery from the century long war only having quelled for 7 years", 
