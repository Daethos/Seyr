...
const attributeCompiler = async (ascean) => {
    ...
    newAttributes.healthTotal = ((newAttributes.totalConstitution * 20) + ((newAttributes.constitutionMod + Math.round((newAttributes.caerenMod + newAttributes.strengthMod) / 2 )) * 20));
